...
import type { ConsequenceResult, PlanDecision, ParsedGpxActivity } from '$lib/training/types';
import type {
...
import {
	requireAthleteTimeZone,
	requireAthleteTimeZoneInTransaction
} from '$lib/server/runway/repositories/profiles';
import { getActivePlan, getPlanWeeks } from '$lib/server/runway/repositories/plan-queries';
import {
	effectiveWeekTargetDistance,
	effectiveWeekTargetDuration,
	isoWeekStart,
	planWeekIdForDate
} from '$lib/server/runway/repositories/schedule-queries';
import { currentTrainingSignal } from '$lib/server/runway/repositories/training-signal';
import {
	getLatestWorkoutAdjustments,
	getWorkoutRecommendationTraces,
