...
- Pain feedback always recommends making the next workout rest and never offers repeating the same prescription. The plan remains recorded so the runner can choose among the remaining non-repeat options; runway does not diagnose the cause or treat a stored schedule as clearance to run.
