...
- An established plan preserves the runner's reported repeatable frequency. Half-marathon plans remain capped at four run days in this planner. That cap is a product constraint informed by the source range below, not a personalized readiness judgment.
