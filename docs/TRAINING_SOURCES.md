...
- An established plan preserves the runner's reported repeatable frequency; the self-described experience label does not silently remove run days. Half-marathon plans remain capped at four run days in this planner. That cap is a product constraint informed by the source range below, not a personalized readiness judgment.
